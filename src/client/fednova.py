...
class FedNovaClient(object):
    ...
    def __init__(self, 
                 ...
                 momentum: float, 
                 device: torch.device, 
                 train_dl_local:  data.DataLoader = None, 
                 test_dl_local:  data.DataLoader = None):
        """
        Parameters:
            name: index of client
            model: local model
            local_bs: local batch-size
            local_ep: number of local epoch
            lr: local learning rate
            device: device of computing
            train_dl_local: local dataloder for training
            test_dl_local: local dataloder for evaluating
        """
